...
public class PlayerControll : MonoBehaviour
{
    ...
    GameObject swhitbox1;
    GameObject swhitbox2;
    GameObject swhitbox3;
    ...
    void Start()
    {
        swhitbox1 = GameObject.Find("SwHitbox1");
        swhitbox2 = GameObject.Find("SwHitbox2");
        swhitbox3 = GameObject.Find("SwHitbox3");
    ...
    void HitBox1()
    {
        ...
        if (GetComponent<Animator>().GetInteger("ArmaEquip") == 0)
        {
            ...
            swhitbox1.GetComponent<CircleCollider2D>().enabled = true;
    ...
    void HitBox2()
    {
        ...
        if (GetComponent<Animator>().GetInteger("ArmaEquip") == 0)
        {
            //swhitbox2 = GameObject.Find("SwHitbox2");
            //GameObject swhitbox = GameObject.Find("SwHitbox");
            swhitbox2.GetComponent<CircleCollider2D>().enabled = true;
            //aSource.PlayOneShot(aAtack, 1f);
        }
        //else
        //{
    ...
    void HitBox3()
    {
        ...
        if (GetComponent<Animator>().GetInteger("ArmaEquip") == 0)
        {
            ...
            //GameObject swhitbox = GameObject.Find("SwHitbox");
            swhitbox3.GetComponent<CircleCollider2D>().enabled = true;
            //aSource.PlayOneShot(aAtack, 1f);
        }
        //else
        //{
    ...
    void Controlers()
    {
        ...
        if (translationX != 0)
        {
            ...
            if (Input.GetAxis("Horizontal") < 0)
            {
                ...
                swhitbox1.transform.position = new Vector2(Player.transform.position.x - 0.9f, swhitbox1.transform.position.y);
                swhitbox2.transform.position = new Vector2(Player.transform.position.x - 1.1f, swhitbox2.transform.position.y);
                swhitbox3.transform.position = new Vector2(Player.transform.position.x - 0.9f, swhitbox3.transform.position.y);
            }
        ...
        else
        {
            Attack = false;
            //GameObject swhitbox = GameObject.Find("SwHitbox");     
            swhitbox1.GetComponent<CircleCollider2D>().enabled = false;
            swhitbox2.GetComponent<CircleCollider2D>().enabled = false;
            swhitbox3.GetComponent<CircleCollider2D>().enabled = false;
